...
from error import SpotifyHTTPError, SpotifySearchTypeError
from objects import Artist, SearchResult, SearchResultDetail
...
class Spotify(SpotifyBase):
    ...
    def search(self, q, search_type, market=None, limit=20, offset=0, raw=False):
        ...
        :param q: str: search keyword
        :param search_type: list: search type(album, artist, playlist, track)
        :param market: str: ISO 3166-1 alpha-2 country code
